-- impl-06-qr.sql
-- Adds attendances table and optional project QR fields
...
CREATE INDEX IF NOT EXISTS idx_attendances_project_applicant ON attendances(project_id, applicant_id);
