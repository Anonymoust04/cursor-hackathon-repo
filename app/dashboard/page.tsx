      ...
      <div className="layout-container flex h-full grow flex-col">
        <header className="sticky top-0 z-50 w-full bg-background-light/80 backdrop-blur-sm">
          <div className="flex justify-center px-4 sm:px-8 md:px-20 lg:px-40">
            <div className="flex w-full max-w-7xl items-center justify-between whitespace-nowrap border-b border-solid border-border-light px-4 md:px-10 py-3">
              ...
              <div className="hidden lg:flex flex-1 justify-end gap-8">
                <div className="flex items-center gap-9">
                  <a className="text-text-light text-sm font-medium leading-normal hover:text-primary" href="#">Dashboard</a>
                  <a className="text-text-light text-sm font-medium leading-normal hover:text-primary" href="#">Gigs</a>
                  <a className="text-text-light text-sm font-medium leading-normal hover:text-primary" href="#">Community</a>
                  <a className="text-text-light text-sm font-medium leading-normal hover:text-primary" href="#">Messages</a>
                </div>
                <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-5 bg-primary text-white text-sm font-bold leading-normal tracking-[0.015em] hover:opacity-90 transition-opacity">
