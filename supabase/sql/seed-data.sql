...
('11111111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'GreenCorp Initiative', 'Sarah Johnson', 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400&h=400&fit=crop', 'Leading environmental sustainability projects and community garden initiatives across urban areas.', '{"website": "https://greencorp.org", "social_links": {"twitter": "@greencorp", "linkedin": "greencorp-org"}}', ARRAY[]::uuid[], ARRAY[]::uuid[], ARRAY[]::uuid[], true),
('22222222-2222-2222-2222-222222222222', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Tech for Good Foundation', 'Michael Chen', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop', 'Empowering underserved communities through technology education and digital literacy programs.', '{"website": "https://techforgood.org", "social_links": {"twitter": "@techforgood", "facebook": "techforgoodfoundation"}}', ARRAY[]::uuid[], ARRAY[]::uuid[], ARRAY[]::uuid[], true),
('33333333-3333-3333-3333-333333333333', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'Education First Alliance', 'Emma Rodriguez', 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400&h=400&fit=crop', 'Bridging educational gaps through tutoring, mentorship, and resource distribution programs.', '{"website": "https://educationfirst.org", "social_links": {"instagram": "@educationfirst", "linkedin": "education-first-alliance"}}', ARRAY[]::uuid[], ARRAY[]::uuid[], ARRAY[]::uuid[], true),
('44444444-4444-4444-4444-444444444444', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'Health & Wellness Community', 'Dr. James Wilson', 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=400&h=400&fit=crop', 'Promoting public health awareness and providing free health screenings and wellness workshops.', '{"website": "https://healthwellness.org", "social_links": {"twitter": "@healthwellness", "linkedin": "health-wellness-community"}}', ARRAY[]::uuid[], ARRAY[]::uuid[], ARRAY[]::uuid[], true),
('55555555-5555-5555-5555-555555555555', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'Arts & Culture Collective', 'Priya Patel', 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400&h=400&fit=crop', 'Supporting local artists and cultural preservation through exhibitions, workshops, and community events.', '{"website": "https://artsculture.org", "social_links": {"instagram": "@artsculture", "facebook": "artsculturecollective"}}', ARRAY[]::uuid[], ARRAY[]::uuid[], ARRAY[]::uuid[], true),
('66666666-6666-6666-6666-666666666666', 'ffffffff-ffff-ffff-ffff-ffffffffffff', 'Youth Development Network', 'David Kim', 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&h=400&fit=crop', 'Mentoring and developing leadership skills in young people through structured programs and activities.', '{"website": "https://youthdev.org", "social_links": {"twitter": "@youthdev", "linkedin": "youth-development-network"}}', ARRAY[]::uuid[], ARRAY[]::uuid[], ARRAY[]::uuid[], true),
('77777777-7777-7777-7777-777777777777', '00000000-0000-0000-0000-000000000001', 'Animal Welfare Society', 'Lisa Anderson', 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400&h=400&fit=crop', 'Rescuing, rehabilitating, and rehoming animals while promoting responsible pet ownership.', '{"website": "https://animalwelfare.org", "social_links": {"instagram": "@animalwelfare", "facebook": "animalwelfaresociety"}}', ARRAY[]::uuid[], ARRAY[]::uuid[], ARRAY[]::uuid[], true);
...
('a1000000-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 
 ...
 'City Center Park, Downtown', 'volunteer', ARRAY['Environment', 'Community', 'Sustainability'], 'open',
...
('a1000000-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111',
 ...
 'Various locations across the city', 'volunteer', ARRAY['Environment', 'Climate'], 'open',
...
('a1000000-0000-0000-0000-000000000003', '11111111-1111-1111-1111-111111111111',
 ...
 'Sunset Beach, Coastal Area', 'volunteer', ARRAY['Environment', 'Marine', 'Community'], 'completed',
...
('a2000000-0000-0000-0000-000000000001', '22222222-2222-2222-2222-222222222222',
 ...
 'Community Center, Midtown', 'volunteer', ARRAY['Education', 'Technology', 'Elderly'], 'ongoing',
...
('a2000000-0000-0000-0000-000000000002', '22222222-2222-2222-2222-222222222222',
 ...
 'Remote / Hybrid', 'paid', ARRAY['Technology', 'Non-Profit'], 'open',
...
('a2000000-0000-0000-0000-000000000003', '22222222-2222-2222-2222-222222222222',
 ...
 'Tech Hub, Innovation District', 'volunteer', ARRAY['Education', 'Technology', 'Youth'], 'open',
...
('a3000000-0000-0000-0000-000000000001', '33333333-3333-3333-3333-333333333333',
 ...
 'Various schools across the district', 'volunteer', ARRAY['Education', 'Youth', 'Mentoring'], 'ongoing',
...
('a3000000-0000-0000-0000-000000000002', '33333333-3333-3333-3333-333333333333',
 ...
 'Community Library, Central Branch', 'volunteer', ARRAY['Education', 'Youth', 'Mentoring'], 'open',
...
('a4000000-0000-0000-0000-000000000001', '44444444-4444-4444-4444-444444444444',
 ...
 'Community Health Center', 'volunteer', ARRAY['Health', 'Community'], 'open',
...
('a4000000-0000-0000-0000-000000000002', '44444444-4444-4444-4444-444444444444',
 ...
 'Wellness Center, Downtown', 'volunteer', ARRAY['Health', 'Mental Health', 'Community'], 'ongoing',
...
('a5000000-0000-0000-0000-000000000001', '55555555-5555-5555-5555-555555555555',
 ...
 'Downtown Arts District', 'volunteer', ARRAY['Arts', 'Culture', 'Community'], 'open',
...
('a5000000-0000-0000-0000-000000000002', '55555555-5555-5555-5555-555555555555',
 ...
 'Convention Center, Event Hall A', 'volunteer', ARRAY['Arts', 'Environment', 'Fashion'], 'completed',
...
('a6000000-0000-0000-0000-000000000001', '66666666-6666-6666-6666-666666666666',
 ...
 'Youth Center, North Campus', 'volunteer', ARRAY['Youth', 'Mentoring', 'Leadership'], 'open',
...
('a6000000-0000-0000-0000-000000000002', '66666666-6666-6666-6666-666666666666',
 ...
 'Community Recreation Center', 'volunteer', ARRAY['Youth', 'Sports', 'Mentoring'], 'ongoing',
...
('a7000000-0000-0000-0000-000000000001', '77777777-7777-7777-7777-777777777777',
 ...
 'Animal Shelter, Westside', 'volunteer', ARRAY['Animals', 'Community'], 'ongoing',
...
('a7000000-0000-0000-0000-000000000002', '77777777-7777-7777-7777-777777777777',
 ...
 'Various locations', 'volunteer', ARRAY['Animals', 'Events'], 'open',
...
('a8000000-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111',
 ...
 'Community Food Bank', 'volunteer', ARRAY['Community', 'Food Security', 'Hunger'], 'open',
...
('a8000000-0000-0000-0000-000000000002', '33333333-3333-3333-3333-333333333333',
 ...
 'Community Center, Eastside', 'volunteer', ARRAY['Education', 'Community', 'Literacy'], 'completed',
...
('b1000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001',
 'Alex Chen', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop',
 1240,
...
('b1000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000002',
 'Jordan Taylor', 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400&h=400&fit=crop',
 850,
...
('b1000000-0000-0000-0000-000000000004', '10000000-0000-0000-0000-000000000004',
 'Sam Rivera', 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&h=400&fit=crop',
 980,
...
('b1000000-0000-0000-0000-000000000006', '10000000-0000-0000-0000-000000000006',
 'Riley Johnson', 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400&h=400&fit=crop',
 720,
...
('b1000000-0000-0000-0000-000000000007', '10000000-0000-0000-0000-000000000007',
 'Taylor Martinez', 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=400&h=400&fit=crop',
 1100,
...
('b1000000-0000-0000-0000-000000000008', '10000000-0000-0000-0000-000000000008',
 'Jamie Wang', 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=400&h=400&fit=crop',
 560,
